        ...
        case 2: // adauga dupa elemnet cu valoare dat din lista
            ...
            while (c!= NULL)
            {
                if (c->v == y)
                {
                    ...
                    if (c->urm == NULL) // c - ultimul element din lista
                    {
                        p=new numar;
                        p->v=a;
                        p->urm=NULL;
...
{
    int cont=0;
    int s; //valoarea care se sterge din lista
...
numar *creare_stiva()
{
    ...
    // creare capat stiva
    cout<<"Valoare cap stiva x = ";
    cin>>x;
    cap=new numar;
    cap->v=x;
    cap->urm=NULL;

    cout<<"Numarul de elemente care se adauga in stiva la cearea listei n = ";
    cin>>n;
    for(int i=1; i<=n; i++)
    {
        cout<<"Valoare de adaugat in lista x = ";
...
// crearea unei liste ordonata din citire
...
numar *creare_lista_ordonata()
{
    ...
    // creare capat lista
    cout<<"Valoare cap initial lista x = ";
    cin>>x;
    cap=new numar;
    cap->v=x;
    cap->urm=NULL;
    u=cap; // ultimul element din lista
    cout<<"Numarul de elemente care se adauga in lista la cearea listei ordonate n = ";
    cin>>n;
    for(int i=1; i<=n; i++)
    {
        cout<<"Valoare de adaugat in lista ordonata x = ";
        cin>>x;
        c=new numar;
        c->v=x;
        c->urm=NULL;
...
{
    // initializarea variabilelor pentru noul polinom rezultat si pointeri pentru parcurgerea listelor
    monom *p, *u, *m, *q;
    float c;
    int g;
    // crearea capatului noului polinom si initializarea valorilor grad si coeficient
    p=new monom;
    p->grad=p1->grad+p2->grad;
    p->coef=p1->coef*p2->coef;
    p->urm=NULL;
    u=p; // ultimul monom din polinom
    q=p2->urm; // pointer pentru a parcurge lista p2
    // parcurgerea listei p1
    while(p1->urm!=NULL)
    {
        p1=p1->urm;
        // parcurgerea listei p2
        while(q!=NULL)
        {
            c=p1->coef*q->coef;
            g=p1->grad+q->grad;
            ...
            m->coef=c;
            m->urm=NULL;
            u->urm=m; // stabileste legatura intre ultimul monom din polinom si noul monom
            u=m; // actualizarea ultimului monom din polinom
            q=q->urm;
        }
        q=p2->urm; // resetarea pointerului pentru a parcurge din nou lista p2
    }
    return p;
}
    ...
    do
    {
        ...
        case 1:
        {
            do
            {
                ...
                cout<<"  Citeste optiune capitol 1: ";
                cin>>op1;
                switch (op1)
                {
                case 1:
                ...
                case 2:
                {
                    ...
                    cout<<"Numar de linii pentru matricea A n = ";
                    cin>>n;
                    cout<<"Numar de coloane pentru matricea A m = ";
                    cin>>m;
                    cout<<"Citeste matricea A:\n";
                    for(int i=0; i<n; i++)
                        for(int j=0; j<m; j++)
                            cin>>A[i][j];
                    cout<<"Numar de linii pentru matricea B p = ";
                    cin>>p;
                    cout<<"Numar de coloane pentru matricea B r = ";
                    cin>>r;
        ...
        case 2:
        {
            do
            {
                ...
                cout<<"  Citeste optiune capitol 2: ";
                cin>>op2;
                switch (op2)
                {
                case 1:
                ...
                break;
                case 0:
                  cout<<"incheiere Sortari!"<<endl;
                  break;
                default:
                    cout<<"Optiune invalida! alegeti din nou!"<<endl;
                    break;
